 ...
 */
export type RemoveOptionalSuffix<TString extends string, TSuffix extends string> = TString extends `${infer T}${TSuffix}`
    ? T
    : TString;

export function removeOptionalSuffix<T extends string, TSuffix extends string>(value: T, suffix: TSuffix): RemoveOptionalSuffix<T, TSuffix> {
