import { Message, Client, GuildMember, MessageOptions, MessageEmbedOptions, InteractionReplyOptions, CommandInteraction, CacheType } from "discord.js";
...
export class SdmCommand implements MessageCommand, ApplicationCommand {
    ...
    handleInteraction(command: CommandInteraction<CacheType>, client: Client<boolean>): Promise<CommandResult> {
        ...
        else if (subcommand === "entscheidung") {
